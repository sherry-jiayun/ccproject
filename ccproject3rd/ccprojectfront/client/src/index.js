...
class Survey extends React.Component {
  ...
  callApi = async () => {
    ...
    if (this.state.value1 === 'Yes' && this.state.value2 === 'Yes'){
      this.setState({response:'SUPER TASTER'});
    }else{
      this.setState({response:'TRADITIONAL TASTER'});
    }
        ...
        <div className="header">
          <div className="innerheader"> 
            <div className="innerheader2">
              <label className="laberheader">Your Taste Profile</label>
